        ...
        mUploadPositiveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                handler1.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(getApplicationContext(), "Uploaded HASH: 9372815afaaa4d51c0db6e4f6f57581f", Toast.LENGTH_SHORT).show();
                    }
                }, 3000);
                ...
                handler2.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(getApplicationContext(), "Uploaded HASH: d5a3e82f8a1b2958d730d65e0e3f7e86", Toast.LENGTH_SHORT).show();
                    }
                }, 4000);
                ...
                handler3.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(getApplicationContext(), "Uploaded HASH: 4b35de24bcaa3c2cbdb1c560a97f1245", Toast.LENGTH_SHORT).show();
                    }
                }, 5000);
